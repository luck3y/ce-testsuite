...
@Template(url = "https://raw.githubusercontent.com/${template.repository:jboss-openshift}/application-templates/${template.branch:master}/eap/eap7cd-mongodb-s2i.json", parameters = {
...
public class Eap7CDMongoDbTest extends EapDbTestBase {
}
