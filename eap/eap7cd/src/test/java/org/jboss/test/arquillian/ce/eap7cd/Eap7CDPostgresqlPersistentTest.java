...
@Template(url = "https://raw.githubusercontent.com/${template.repository:jboss-openshift}/application-templates/${template.branch:master}/eap/eap7cd-postgresql-persistent-s2i.json", parameters = {
...
public class Eap7CDPostgresqlPersistentTest extends EapPersistentTestBase {
