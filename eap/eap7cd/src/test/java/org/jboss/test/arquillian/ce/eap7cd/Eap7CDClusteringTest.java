...
@Template(url = "https://raw.githubusercontent.com/${template.repository:jboss-openshift}/${template.branch:master}/templates/eap-cd-basic-s2i.json", parameters = {
...
@OpenShiftResource("https://raw.githubusercontent.com/${template.repository:jboss-openshift}/${template.branch:master}/secrets/eap7-app-secret.json")
@RoleBindings({
        @RoleBinding(roleRefName = "view", userName = "system:serviceaccount:${kubernetes.namespace}:default"),
        @RoleBinding(roleRefName = "view", userName = "system:serviceaccount:${kubernetes.namespace}:eap7-service-account") })
public class Eap7CDClusteringTest extends EapClusteringTestBase {
}
